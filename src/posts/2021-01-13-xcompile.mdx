...
I will discuss the *second* use case.
...
3. With this GCC compiler and libgcc, the C standard library libc for the target
   system can be built.
4. Finally, with the libc for the target system, we are now able to build a
